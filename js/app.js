 ...
 */
    ...
    (() => {
            ...
            window.addEventListener("load", (function(e) {
                ...
                function initItem(showMoreBlock, matchMedia = false) {
                    ...
                    if (matchMedia.matches || !matchMedia) if (hiddenHeight < getOriginalHeight(showMoreContent)) {
                        ...
                        showMoreContent.classList.add("_showed");
                    } else {
                        _slideDown(showMoreContent, 0, hiddenHeight);
                        showMoreButton.hidden = true;
                        showMoreContent.classList.remove("_showed");
                    } else {
                        _slideDown(showMoreContent, 0, hiddenHeight);
                        showMoreButton.hidden = true;
                    }
        ...
        function initSliders() {
            if (document.querySelector(".marquee__slider")) new core(".marquee__slider", {
            ...
            if (cardsSliders) cardsSliders.forEach((e => {
                ...
                new core(e.querySelector(".item-slider__big-slider"), {
                    modules: [ Navigation, Pagination ],
                    slidesPerView: 1,
                    spaceBetween: 10,
                    speed: 400,
                ...
                new core(e.querySelector(".item-slider__biggest-slider"), {
                    modules: [ Navigation, Pagination ],
                    slidesPerView: 1,
                    spaceBetween: 10,
                    speed: 400,
            ...
            if (document.querySelector(".classes__slider")) new core(document.querySelector(".classes__slider"), {
                modules: [ Navigation, Pagination ],
                slidesPerView: 1,
                spaceBetween: 10,
                speed: 400,
                simulateTouch: false,
                pagination: {
                    el: ".classes__pagintaion",
                    clickable: true
                },
                navigation: {
                    nextEl: ".classes__btn-next",
                    prevEl: ".classes__btn-prev"
                }
            });
